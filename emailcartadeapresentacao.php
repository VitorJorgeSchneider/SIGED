...
try {
    ...
    $mail->Body = "Olá! ". $colunaprofessor['nome'] ." <br> Existe uma solicitação de assinatura para você!
    <a href=http://168.228.253.7/~vitor/>Clique Aqui!</a> Para ser redirecionado(a) ao portal!";
